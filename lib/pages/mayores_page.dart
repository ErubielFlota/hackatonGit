...
class AdultosPage extends StatefulWidget { 
  ...
  @override
  State<AdultosPage> createState() => _AdultosPageState();
}

class _AdultosPageState extends State<AdultosPage> {
  ...
  final Query _programasFiltradosQuery =
      FirebaseFirestore.instance
          ...
          .where('categoria', isEqualTo: 'Adultos');
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (programasFiltrados.isEmpty) {
                      return Center(
                        child: Text(
                          filtro.isEmpty
                          ? 'No hay programas activos en la categoría Adultos.' 
