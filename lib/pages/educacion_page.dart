...
class ProgramasEducacionPage extends StatefulWidget { 
  const ProgramasEducacionPage({super.key});

  @override
  State<ProgramasEducacionPage> createState() => _ProgramasEducacionPageState();
}

class _ProgramasEducacionPageState extends State<ProgramasEducacionPage> {
  ...
  final Query _programasFiltradosQuery =
      FirebaseFirestore.instance
          ...
          .where('categoria', isEqualTo: 'Educacion'); 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Programas de Educación'), 
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (programasFiltrados.isEmpty) {
                      return Center(
                        child: Text(
                          filtro.isEmpty
                          ? 'No hay programas activos en la categoría Educación.' 
